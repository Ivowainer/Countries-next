...
import { Country, Curren, TartuGecko } from '../../interfaces/CountriesAll';
        ...
        <div className="py-8">
            ...
            <div className="mt-7 flex flex-col sm:flex-row gap-2 sm:gap-20">
                <div className="flex flex-col gap-2">
                    ...
                    <p className="font-bold text-sm">Population: <span className="font-normal">{population}</span></p>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="font-bold text-sm">Currencies: <span className="font-normal">{coin?.name}</span></p>
